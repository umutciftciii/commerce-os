...
export const SHIPMENT_EVENT_LABEL: Record<Locale, Record<ShipmentEventType, string>> = {
  tr: {
    ...
    DESTINATION_REPAIRED: "İl/ilçe eşlemesi düzeltildi",
    MANUAL_STATUS: "Durum elle güncellendi",
    CANCELLED: "İptal edildi",
  ...
  en: {
    ...
    DESTINATION_REPAIRED: "City/district mapping repaired",
    MANUAL_STATUS: "Status updated manually",
    CANCELLED: "Cancelled",
