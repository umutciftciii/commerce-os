...
- **Durum.** Worktree'de DONE (commit/PR/merge/deploy YOK — brief gereği). Gate + Docker gerçek-PG smoke ALL PASS. Sıradaki: TODO-155.2 (kampanya rozeti snapshot + reconciliation sweep) veya TODO-156B (storefront wiring).
