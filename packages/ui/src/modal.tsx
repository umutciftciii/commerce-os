    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          // govde alani tasinca kendi icinde kayar (uzun formlar erisilebilir).
          "relative z-10 flex max-h-[calc(100vh-2rem)] w-full max-w-lg flex-col rounded-xl border border-slate-200 bg-white shadow-panel focus:outline-none",
          className,
        )}
      >
