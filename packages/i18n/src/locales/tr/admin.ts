...
export const trAdmin = {
  ...
  errors: {
    ...
    VERSION_CONFLICT: "Bu talep bu sırada güncellendi; en güncel hâli yüklendi. Lütfen tekrar deneyin.",
    REQUEST_NOT_FOUND: "Talep bulunamadı.",
    INVALID_TRANSITION: "Bu durum geçişi yapılamaz.",
    CLOSE_REASON_REQUIRED: "Kapatma için bir neden seçmelisiniz.",
    INVALID_CLOSE_REASON: "Bu durumda seçilen kapatma nedeni geçersiz.",
    ALREADY_CLOSED: "Talep zaten kapatılmış.",
    ASSIGNEE_NOT_FOUND: "Seçilen kullanıcı bulunamadı.",
    CATEGORY_KEY_EXISTS: "Bu kategori anahtarı zaten kullanılıyor.",
  },
  nav: {
    heading: "Yönetim",
